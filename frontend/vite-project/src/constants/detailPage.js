...
export const Luggage = ({ className }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
export const PrayerRoom = ({ className }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
export const ShowerHead = ({ className }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
export const Wheelchair = ({ className }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
export const Elevator = ({ className }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
export const infoBoxMessages = [
    "خدمات رایگان هتل مدینه الرضا مشهد: ترانسفر استقبال و بدرقه فرودگاهی فقط برای پرواز های داخلی، ترانسفر بدرقه به راه آهن. استفاده نامحدود از استخر، اینترنت نامحدود، یک قطعه عکس آتلیه",
