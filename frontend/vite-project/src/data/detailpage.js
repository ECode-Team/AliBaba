...
export const faqData = [
  ...
  },
  {
    ...
    answer: "هتل مدینه الرضا مشهد، یک هتل پنج ستاره با خدمات و امکانات مناسب است و در میان هتل‌های برتر پنج ستاره مشهد قرار گرفته است. برای اطلاعات بیشتر می‌توانید به سایت علی بابا مراجعه کنید.",
  },
  {
    question:
  ...
  },
  {
    ...
    answer: "در هتل مدینه الرضا، ساعت تحویل اتاق (ورود) از ساعت ۱۴:۰۰ و ساعت تخلیه اتاق (خروج) تا ساعت ۱۲:۰۰ ظهر می‌باشد.",
  },
  {
    question: "امکانات هتل مدینه الرضا مشهد چیست?",
    answer: "این هتل امکانات متنوعی از جمله سالن بازی (شامل آمفی قایق، بازی‌های کامپیوتری و زمین بازی کودک)، مجموعه آبی در محوطه باز و باغ‌های سرسبز را برای میهمانان فراهم کرده است.",
  },
  {
    question: "فاصله نزدیک‌ترین فرودگاه به هتل مدینه الرضا مشهد چقدر است?",
    answer: "هتل مدینه الرضا مشهد از نزدیک‌ترین هتل‌ها به فرودگاه است. در زمان‌های اوج سفر و ترافیک، می‌توانید با پرداخت هزینه تاکسی به راحتی خود را به هتل برسانید.",
  },
  {
    question: "کدام هتل‌ها مشابه هتل مدینه الرضا مشهد هستند?",
    answer: "در مشهد هتل‌های پنج ستاره متعددی وجود دارند. هتل‌هایی مانند هتل قصر طلایی با معماری لوکس و هتل قصر بین المللی با اتاق‌های مجلل، از گزینه‌های مشابه و باکیفیت هستند که می‌توانید آن‌ها را نیز بررسی کنید.",
  },
];
