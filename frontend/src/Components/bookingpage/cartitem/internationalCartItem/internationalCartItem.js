...
import "./internationalCartItem.scss";
export const InternationalCartItem = ({ setIsOpen }) => {
            ...
            <div className="booking-cart-item-container-right-side">
              ...
              <div className="booking-cart-item-container-right-side-image-text-container">
                ...
                <div className="booking-cart-item-container-right-side-image-text-subject">
                  ...
                  <p className="booking-cart-item-container-right-side-image-text grey">
                    1×30kg
                    
                  </p>
                  <span className="booking-cart-item-container-right-side-image-text grey-1">
                      svg
                    </span>
                </div>
              </div>
